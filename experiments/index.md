...
| [045](045-fresh-slice-gripper-localization.md) | where does the joint gripper deficit localize on the final focused-assay-fresh slice? | freeze expert-only structural support before any checkpoint load or policy inference. |
